        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Card
            ...
            content={
              <div className="space-y-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">{analytics.averagePriority}</div>
                  <p className="text-gray-500">Avg Priority Score</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-teal-600">{analytics.averageWaitTime}min</div>
            ...
            content={
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-blue-600">{waitingPatients.length}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">In Treatment</span>
                  <span className="font-bold text-purple-600">{inTreatmentPatients.length}</span>
                </div>
                <div className="flex justify-between items-center">
